...
**Tabela 1** - Cronograma Geral Planejado do Projeto
...
### 3.1. Planejado
Na Tabela 2, encontra-se o cronograma planejado especificamente para as atividades da primeira entrega, contemplando a divisão estruturada de tarefas entre os membros para a definição da equipe, escolha do site Semob-DF, processo de design e elaboração do planejamento.

**Tabela 2** - Cronograma Planejado: Entrega 1

| Atividade | Descrição da Tarefa | Autor(es) | Revisor(es) | Data de Início | Data de Fim |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Site Selecionado** | Redigir a motivação e os critérios de escolha do Semob-DF, justificando os problemas de IHC. | Carlos | Igor | 04/09/2026 | 05/09/2026 |
| **Sites Descartados** | Listar e avaliar os outros sites do governo cogitados, explicando os motivos do descarte. | Rodrigo | Carlos | 04/09/2026 | 05/09/2026 |
| **Processo de Design** | Explicar o ciclo de vida escolhido e justificar teoricamente a escolha. | Tomas | Rodrigo | 04/09/2026 | 05/09/2026 |
| **Ferramentas & Heatmap** | Descrever ferramentas (Figma, Git) e montar o Heatmap de disponibilidade. | Gabriel | Tomas | 04/09/2026 | 05/09/2026 |
...
**Tabela 3** - Cronograma Executado: Entrega 1

| Atividade | Descrição da Tarefa | Autor(es) | Revisor(es) | Data de Início | Data de Fim |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Site Selecionado** | Redação da motivação e critérios de escolha do Semob-DF. | Carlos | Igor | 05/09/2026 | 06/09/2026 |
| **Sites Descartados** | Avaliação e justificativa de descarte de sites alternativos. | Rodrigo | Carlos | 05/09/2026 | 06/09/2026 |
